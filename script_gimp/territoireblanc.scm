(define (territoireblanc fname-one outputfilename)
    (let* (
	...
	(plug-in-colorify RUN-NONINTERACTIVE image drawable1 "white")
	(plug-in-colorify RUN-NONINTERACTIVE image drawable2 "white")
	; Lum / contraste plan
